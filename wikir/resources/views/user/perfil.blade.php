                ...
                <div class="card-body">
                    ...
                    <div id="info_user" class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    @if(isset($img) && $img != null)
                                        <img src="{{asset('storage/users/'.$img->img_user)}}"></br>
                                    @else
                                        <img src="{{asset('storage/users/blank.png')}}"></br>
                                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <button class="btn btn-default" data-toggle="modal" data-target="#editProfileModal">Editar nome</button>
                                </div>
                                <div class="col-md-6"> 
                                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#imageModal">Editar imagem</button>
                                </div>  
                            </div>
...
<div id="imageModal" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="{{route('img.change')}}" enctype="multipart/form-data">
            @csrf
            <div class="form-group row">
